...
export const dancehallSquareTracks: DancehallSquareTrack[] = [
  {
    id: 1,
    title: "Island Vibes",
    artist: "Neka", // replaced fictional name with actual SquareDrum roster artist
    duration: "3:28",
  ...
  },
  {
    id: 2,
    title: "Bashment Flow",
    artist: "Danni Blaze", // replaced fictional name with actual SquareDrum roster artist
    duration: "3:45",
    audioUrl: "/audio/placeholder.mp3",
  ...
  },
  {
    ...
    artist: "J Cruz", // replaced fictional name with actual SquareDrum roster artist
    duration: "3:33",
    audioUrl: "/audio/placeholder.mp3",
