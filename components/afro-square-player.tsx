...
export default function AfroSquarePlayer({ tracks, onDownloadClick }: AfroSquarePlayerProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-orange-900/20 to-red-900/20 backdrop-blur-sm border border-orange-500/20 rounded-xl p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="font-cinzel text-xl font-bold text-orange-400 mb-1">AFRO SQUARE</h3>
      ...
      <div className="flex items-center space-x-4 mb-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-orange-400 text-sm truncate">{currentTrack.artist}</p>
      ...
      <div className="flex items-center justify-center space-x-1 mb-4">
        <Button
          ...
          className={`text-gray-400 hover:text-white ${shuffle ? "text-orange-400" : ""}`}
          title="Shuffle"
        >
        ...
        <Button
          ...
          className={`text-gray-400 hover:text-white ${repeat !== "none" ? "text-orange-400" : ""}`}
          title={`Repeat: ${repeat}`}
        >
